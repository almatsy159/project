...
class Form_Create_Block(qtw.QDialog):
    ...
    def validate(self):
        ...
        {self.e_Content_id.text()},{self.type_cbb.currentData()},{self.e_Parent_id.text()},
        {self.theme_cbb.currentData()},{self.content_type_cbb.currentData()})
        """
        print(req)
        db.Exec_cursor(req)
        db.Conn_Close()
        if __name__ != "__main__" and self.parent != None:
            self.parent.entry_last_item_created.setText(self.e_Block_id.text())
        else:
...
class Form_Create_Content(qtw.QDialog):
    def __init__(self,parent=None):
        ...
        self.l_Content_id=qtw.QLabel("Content ID :")
        self.e_Content_id=qtw.QLineEdit()
        self.e_Content_id.setText(str(db.next_id("content","content_id")))
...
class Form_Create_Theme(qtw.QDialog):
    def __init__(self,parent=None):
        ...
        self.l_Theme_id=qtw.QLabel("Theme ID :")
        self.e_Theme_id=qtw.QLineEdit()
        self.e_Theme_id.setText(str(db.next_id("theme","theme_id")))
    ...
    def reset(self):
        self.e_Theme_id.setText("")
        self.e_Theme_name.setText("")
...
class Form_Create_Block_Type(qtw.QDialog):
    def __init__(self,parent=None):
        ...
        self.l_Type_id=qtw.QLabel("Block Type ID :")
        self.e_Type_id=qtw.QLineEdit()
        self.e_Type_id.setText(str(db.next_id("block_type","type_id")))
        self.main_layout.addWidget(self.l_Type_id,0,0)
        self.main_layout.addWidget(self.e_Type_id,0,1)

        self.l_Type_name=qtw.QLabel("Block Type Name :")
...
class Form_Create_Content_Type(qtw.QDialog):
    def __init__(self,parent=None):
        ...
        self.e_Content_type_id=qtw.QLineEdit()
        #self.e_Content_type_id.setText()
...
class DB():
    ...
    def select_all(self,table,col="*",osef=0):
        print(self.show_columns_name(table))

        req=f"SELECT {col} FROM {table}"
    ...
    def select_one_record(self,table,cond,col="*"):
        print(self.show_columns_name(table))
        req=f"SELECT {col} FROM {table} WHERE {cond}"
        x=self.make_a_req(req)
        return x

    def select_one_column_items(self,table,col):
        print(self.show_columns_name(table))
        req=f"SELECT {col} FROM {table}"
        x=self.make_a_req(req)
        return x
    ...
    def show_columns_name(self,table):
        name_list=[]
